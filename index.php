		    ...
		    <table class="form-table">
		    	...
		    	if( empty(get_option('ezeep_code')) && !(empty(get_option('ezeep_redirect_uri'))) ) { ?>
			        <tr valign="top">
				        ...
				        <td>
				        	<a href="https://account.ezeep.com/oauth/authorize/?response_type=code&client_id=<?php echo $ezeep_client_id; ?>&redirect_uri=<?php echo esc_attr( get_option('ezeep_redirect_uri') ); ?>">Authorize</a>
				        </td>
			        </tr>
